...
console.log("The beginning worked but I had issues later on.");
...
console.log("Not exactly but thats because I fell behind.");
...
console.log("Everything was for the most part new.");
